...
parser = argparse.ArgumentParser(
    description="Infomax Representations - Training Script"
)
# parameters for general training stuff
parser.add_argument("--dataset", type=str, default="STL10")
parser.add_argument(
    "--batch_size", type=int, default=200, help="input batch size (default: 200)"
)
...
parser.add_argument("--ndf", type=int, default=128, help="feature width for encoder")
parser.add_argument(
    "--n_rkhs",
    type=int,
    default=1024,
...
parser.add_argument(
    "--tclip", type=float, default=20.0, help="soft clipping range for NCE scores"
)
