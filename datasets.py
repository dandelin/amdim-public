...
class TransformsSTL10:
    ...
    def __init__(self):
        ...
        rand_crop = transforms.RandomResizedCrop(
            64, scale=(0.3, 1.0), ratio=(0.7, 1.4), interpolation=INTERP
        )
...
def build_dataset(dataset, batch_size, input_dir=None, labeled_only=False):
    ...
    if dataset == Dataset.C10:
        ...
        train_dataset = datasets.CIFAR10(
            root="/tmp/data/", train=True, transform=train_transform, download=True
        )
        test_dataset = datasets.CIFAR10(
            root="/tmp/data/", train=False, transform=test_transform, download=True
        )
        ...
        test_dataset = datasets.STL10(
            root="/tmp/data/", split="test", transform=test_transform, download=True
        )
